...
class Lang_Auto_Detect
{
    ...
    public $lang = Array('en' => array('English',
    ...
    private function _prepare_str($tmp_str = NULL)
    {
        ...
        else if(mb_strlen($tmp_str, $tmp_encoding) <= $this->min_str_len_detect
        )
        {
            return FALSE;
        }
    ...
    private function _detect_from_tables($tmp_str = NULL)
    {
        ...
        arsort($lang_res,
               SORT_NUMERIC); //сортируем массив первый элемент язык с большей вероятностью
